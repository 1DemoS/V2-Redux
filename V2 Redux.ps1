...
Clear-Host
$Host.UI.RawUI.WindowTitle = "🔍Оптимизация  [~60 сек]"

Write-Host "=== Проверка мусора ===" -ForegroundColor Red -BackgroundColor Black
Write-Host "Сканирование папки Temp" -ForegroundColor Yellow
...
# === 1. ПРОЦЕССЫ (15 сек) ===
Write-Host "`n[1/6] 🔍 Сканирование процессов temp..." -ForegroundColor Cyan
Show-Spinner "Анализ DLL и инжекторов..." 15

# === 2. .GTA5  (15 сек) ===
Write-Host "`n[2/6] 📁 Cканирование grand theft auto 5..." -ForegroundColor Cyan
